              ...
              <div className="relative" ref={userMenuRef}>
                ...
                {userMenuOpen && (
                  <div className="absolute right-0 mt-2 w-48 rounded-xl border border-white/10 bg-[#0f0f18]/95 py-2 shadow-2xl backdrop-blur-xl">
                    ...
                    <button
                      className="w-full cursor-pointer px-4 py-2.5 text-left text-sm text-slate-300 transition hover:bg-white/5 hover:text-white"
                      onClick={() => { setUserMenuOpen(false); onOpenProfile() }}
                    >
                      ⚙️ Profil
                    </button>
                    <button
                      className="w-full cursor-pointer px-4 py-2.5 text-left text-sm text-rose-400 transition hover:bg-rose-500/10"
          ...
          <div className="animate-fade-in mt-2 rounded-2xl border border-white/10 bg-[#0f0f18]/95 p-3 backdrop-blur-xl lg:hidden">
            <div className="flex flex-col gap-1">
              ...
              {user ? (
                <>
                  <button
                    className="mt-2 cursor-pointer rounded-xl bg-violet-600 px-4 py-3 text-sm font-medium text-white"
                    onClick={onOpenProfile}
                  >
                    ⚙️ Profil
                  </button>
                  <button
                    className="cursor-pointer rounded-xl border border-rose-500/30 px-4 py-3 text-sm font-medium text-rose-400 transition hover:bg-rose-500/10"
                    onClick={() => void logout()}
                  >
                    🚪 Keluar
                  </button>
